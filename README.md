...
| `initFromFile`                                  | `$file`                                                                                       | `protected` | Initialises lines from a file                                                                                                                                    |
| `initFromLines`                                 | `$lines`                                                                                      | `protected` | Initialises the parser using an array containing each line of iCal content                                                                                       |
| `initFromString`                                | `$string`                                                                                     | `protected` | Initialises lines from a string                                                                                                                                  |
| `initFromUrl`                                   | `$url`, `$username = null`, `$password = null`, `$userAgent = null`, `$acceptLanguage = null` | `protected` | Initialises lines from a URL. Accepts a username/password combination for HTTP basic authentication, a custom User Agent string and the accepted client language |
